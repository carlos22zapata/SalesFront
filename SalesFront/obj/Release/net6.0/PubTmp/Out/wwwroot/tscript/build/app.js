...
function validarInputNumber(inputText) {
    ...
    var result_ = regex.test(inputText);
...
function fnSalesDetailUpdate(carNum, carItem) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = fetch(url, {
            ...
            yield $('#TxtAmountSaleDetail').val(result.amount.toLocaleString('en-US', { minimumFractionDigits: 0 }));
            yield $('#TxtUtilitySaleDetail').val(result.utility.toLocaleString('en-US', { minimumFractionDigits: 0 }));
            yield $('#TxtMkupSaleDetail').val(result.mkup.toLocaleString('en-US', { minimumFractionDigits: 0 }));
        }));
    });
}
